...
<Info>
  SSO is available on **Enterprise plans**. Contact your Qumis Client Partner or email [support@qumis.ai](mailto:support@qumis.ai) to enable SSO for your organization.
</Info>
...
Your Qumis Client Partner team will request the following information to configure SSO on our end:
...
<Steps>
  <Step title="Contact Your Qumis Client Partner">
    Reach out to your Qumis Client Partner or email [support@qumis.ai](mailto:support@qumis.ai) to initiate the SSO setup process. We'll schedule a brief kickoff call to review requirements and timeline.
  </Step>

  <Step title="Configure Qumis Application in Your IdP">
  ...
  <Step title="Provide Configuration Details to Qumis">
...
Contact your Qumis Client Partner if this applies to your use case.
...
<AccordionGroup>
  <Accordion title="Users receive 'SSO Configuration Not Found' error">
  ...
  <Accordion title="SAML assertion errors">
  ...
  <Accordion title="OIDC authentication failures">
  ...
  <Accordion title="Users created but missing information">
...
<AccordionGroup>
  <Accordion title="Can we enforce SSO as the only login method?">
  ...
  <Accordion title="What happens if our IdP experiences downtime?">
  ...
  <Accordion title="Can we configure multiple IdP connections?">
    Organizations typically use a single IdP connection. Contact your Client Partner if you have a specific use case requiring multiple connections.
  </Accordion>

  <Accordion title="How do we offboard users?">
  ...
  <Accordion title="Does SSO support Multi-Factor Authentication (MFA)?">
  ...
  <Accordion title="Can we customize the login page?">
    Qumis provides a standard enterprise login experience. For custom branding requirements, please contact your Client Partner.
  </Accordion>
</AccordionGroup>
...
Ready to configure SSO for your organization? Contact your Qumis Client Partner or email [support@qumis.ai](mailto:support@qumis.ai) to begin the setup process.

We're here to ensure a smooth implementation and answer any questions throughout the process.

<CardGroup cols={2}>
  <Card title="Navigating the Dashboard" icon="compass" href="/get-started/setup/navigating-the-dashboard">
    Get familiar with Qumis after logging in
  </Card>
  <Card title="Inviting Users" icon="user-plus" href="/get-started/setup/inviting-users">
    Add team members to your Qumis organization
  </Card>
</CardGroup>
