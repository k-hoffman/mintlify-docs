...
<CardGroup cols={2}>
  ...
  <Card title="Presenting Quotes Playbook" icon="person-chalkboard" href="/playbooks/broking/client-presentation">
    Build client-ready presentations from your coverage data
  </Card>
