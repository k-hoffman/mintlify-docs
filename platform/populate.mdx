...
- If using a custom checklist, have your list of fields ready or saved in the Prompt Library. See the [Checklist Template Guide](/reports/template-guide) for how to write templates with repeating groups and nesting.
