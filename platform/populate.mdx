...
description: "Extract structured coverage data from insurance policies into clear, side-by-side tables for proposals, renewals, and client presentations."
icon: "table"
sidebarTitle: "Coverage Table"
---
...
- If using a custom checklist, have your list of fields ready or saved in the Prompt Library. See the [Checklist Template Guide](/playbooks/best-practices/coverage-checklists) for how to write templates with repeating groups and nesting.

---

<Steps>
  <Step title="Access the Coverage Table tool">
    ...
    <Frame caption="Coverage Table dashboard showing existing reports and create button">
      <img src="/images/screenshots/coverage-table-dashboard.png" alt="Coverage Table dashboard showing existing reports and create button" />
    </Frame>
  </Step>

  <Step title="Upload your policy documents">
    ...
    <Frame caption="Document upload interface with vault search and file drop options">
      <img src="/images/screenshots/coverage-table-upload.png" alt="Document upload interface with vault search and file drop options" />
    </Frame>
  </Step>
  ...
  <Step title="Add checklist items">
    ...
    <Frame caption="Auto-generate checklist toggle enabled">
      <img src="/images/screenshots/coverage-table-auto-generate.png" alt="Auto-generate checklist toggle enabled" />
    </Frame>
    ...
    **Method 2: Use a saved checklist from Prompt Library**
    ...
    <Frame caption="Custom checklist input with Prompt Library integration">
      <img src="/images/screenshots/coverage-table-custom-checklist.png" alt="Custom checklist input with Prompt Library integration" />
    </Frame>
  </Step>

  <Step title="Best practices for checklist creation">
    <AccordionGroup>
      <Accordion title="Create line-of-business-specific checklists">
      ...
      <Accordion title="Save frequently-used checklists">
  ...
  <Step title="Generate your coverage table">
    ...
    <Frame caption="Generate Coverage Table button initiating the analysis process">
      <img src="/images/screenshots/coverage-table-generate.png" alt="Generate Coverage Table button initiating the analysis process" />
    </Frame>
  </Step>

  <Step title="Review your completed coverage table">
    ...
    <Frame caption="Completed coverage table showing side-by-side policy comparison with match status">
      <img src="/images/screenshots/coverage-table-results.png" alt="Completed coverage table showing side-by-side policy comparison with match status" />
    </Frame>
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="My table didn't extract the information I expected">
  ...
  <Accordion title="Some fields show 'Not Available'">
  ...
  <Accordion title="My coverage table is taking too long to generate">
    Average generation time is 5–10 minutes. If it exceeds 15 minutes, refresh the page or re-upload the documents.
  </Accordion>

  <Accordion title="How do I create a checklist for a new line of business?">
...
The **Coverage Table** complements **Compare Documents** for policy-level differences and **Policy Analysis** for detailed individual policy review. Use Coverage Tables when you need clean, client-ready summaries of coverage information to include in proposals and presentations.
...
<CardGroup cols={2}>
  <Card title="Compare Documents" icon="code-compare" href="/platform/compare">
    Side-by-side policy comparison with detailed analysis
  </Card>
  <Card title="Checklist Template Guide" icon="list-check" href="/playbooks/best-practices/coverage-checklists">
    Learn how to write effective checklist templates
  </Card>
