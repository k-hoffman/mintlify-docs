...
<CardGroup cols={2}>
  ...
  <Card title="Competitive Quoting Playbook" icon="arrows-left-right" href="/playbooks/broking/competitive-quoting">
    Step-by-step workflow for comparing competing quotes
  </Card>
