...
<Note>
  **Prerequisites:**
  ...
  - Documents can be up to 1,000 pages combined.
...
<Steps>
  <Step title="Access the Compare Documents tool">
    1. From the sidebar, click **Compare Documents**.
    ...
    <Frame caption="Compare Documents dashboard showing existing reports and option to create new comparison">
      <img src="/images/screenshots/compare-documents-dashboard.png" alt="Compare Documents dashboard showing existing reports and option to create new comparison" />
    </Frame>
  </Step>

  <Step title="Upload your documents">
    To generate a Compare Documents, upload **at least two documents** (PDF, Word, Excel, or image formats).
    ...
    4. You can upload up to 1,000 pages total. Qumis will automatically read, align, and compare them.

    <Frame caption="Document upload interface showing drag-and-drop area and uploaded files">
      <img src="/images/screenshots/compare-documents-upload.png" alt="Document upload interface showing drag-and-drop area and uploaded files" />
    </Frame>
  </Step>

  <Step title="Add optional additional context">
    ...
    <Frame caption="Additional information input field for providing context to guide the analysis">
      <img src="/images/screenshots/compare-documents-additional-info.png" alt="Additional information input field for providing context to guide the analysis" />
    </Frame>
  </Step>

  <Step title="Generate your comparison report">
    ...
    <Frame caption="Report generation progress screen with status updates and estimated completion time">
      <img src="/images/screenshots/compare-documents-generate-report.png" alt="Report generation progress screen with status updates and estimated completion time" />
    </Frame>
  </Step>

  <Step title="Review your comparison results">
    ...
    **Action Items**
    ...
    <Frame caption="QumisScore dashboard showing coverage alignment chart and impact analysis metrics">
      <img src="/images/screenshots/compare-documents-qumis-score.png" alt="QumisScore dashboard showing coverage alignment chart and impact analysis metrics" />
    </Frame>

    These insights highlight where material differences exist and where coverage improvements could be negotiated.
  </Step>

  <Step title="Explore the coverage comparison table">
    ...
    <Frame caption="Interactive coverage comparison table with filtering and search options">
      <img src="/images/screenshots/compare-documents-coverage-table.png" alt="Interactive coverage comparison table with filtering and search options" />
    </Frame>
  </Step>

  <Step title="Download the comparison table">
  ...
  <Step title="Chat with your comparison report">
  ...
  <Step title="Use the QumisScore in your recommendations">
  ...
  <Step title="Use the comparison for your pitch">
    Once you have your Compare Documents, use it strategically:
  ...
  <Step title="Access previous comparisons">
    Your previously generated Compare Documents reports are saved and listed on the Compare Documents dashboard.

    1. Go to **Compare Documents** in the left sidebar.
...
<AccordionGroup>
  <Accordion title="My comparison is taking too long to generate">
    Average time is 5–10 minutes. If it exceeds 15 minutes, refresh the page or re-upload the documents.
  </Accordion>

  <Accordion title="I uploaded only one file">
    You must upload at least two documents to generate a comparison.
  </Accordion>

  <Accordion title="I need to upload more than two documents">
    Qumis supports multiple document comparisons. Add as many documents as you need (up to 1,000 pages total). The report will analyze all of them.
  </Accordion>

  <Accordion title="The results seem incomplete">
  ...
  <Accordion title="Can I compare more than two documents?">
    Yes. You can upload multiple quotes or binders for multi-way comparisons.
  </Accordion>

  <Accordion title="Where are my past comparisons?">
    All completed comparisons appear on the **Compare Documents dashboard**. Go to **Compare Documents** in the left sidebar to access them.
  </Accordion>

  <Accordion title="Can I add or remove documents from an existing comparison?">
  ...
  <Accordion title="I want to compare documents with my team">
...
## Where Compare Documents fits in the Qumis platform

The **Compare Documents** complements **Policy Analysis** for individual policy review and **Chats** for ad-hoc questions. Use it whenever you need to evaluate multiple documents against each other to make informed recommendations to prospects and clients.

---

### Why use Compare Documents reports?
...
<CardGroup cols={2}>
  <Card title="Policy Analysis" icon="sitemap" href="/platform/summarize">
    Analyze a single policy in depth before comparing
  </Card>
  <Card title="Coverage Table" icon="table" href="/platform/populate">
    Extract structured coverage data into side-by-side tables
  </Card>
  <Card title="Presenting Quotes Playbook" icon="presentation-screen" href="/playbooks/broking/quote-comparison">
