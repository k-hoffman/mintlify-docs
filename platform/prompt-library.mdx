...
<CodeGroup>
  ```text Analysis Prompt theme={null}
  ...
  ```text Coverage Checklist Prompt theme={null}
...
<AccordionGroup>
  <Accordion title="Coverage Checklists">
    <CodeGroup>
      ```text WC Coverage Verification theme={null}
      ...
      ```text General Liability Audit theme={null}
      ...
      ```text Cyber Policy Coverage Check theme={null}
  ...
  <Accordion title="For Brokers">
    <CodeGroup>
      ```text Quote Comparison theme={null}
      ...
      ```text Premium Extraction theme={null}
  ...
  <Accordion title="For Claims Professionals">
    <CodeGroup>
      ```text Coverage Determination theme={null}
      ...
      ```text Exclusions Analysis theme={null}
