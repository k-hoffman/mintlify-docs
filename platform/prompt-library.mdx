...
The Prompt Library helps you create, save, and reuse structured AI instructions—called prompts—for faster and more consistent insurance document analysis. Whether you're drafting a detailed policy analysis or refining a question for Chat, the Prompt Library keeps your best prompts at your fingertips.
...
<Tabs>
  ...
  <Tab title="Coverage Checklist Prompt">
...
<AccordionGroup>
  ...
  <Accordion title="My prompt returns different results on different policies">
