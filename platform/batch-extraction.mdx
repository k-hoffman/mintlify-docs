...
## Configuring your extraction template

This section covers everything you need to define, validate, and submit a custom extraction template. Qumis uses this template to determine which fields to pull from each document — so the more precise your template, the better your results.
