...
<Steps>
  <Step title="Open Single Policy">
    Click **Single Policy** from the left sidebar.
  </Step>

  <Step title="View your analyses dashboard">
...
<Frame caption="Single Policy Analysis dashboard showing all saved reports with names, associated files, and last modified dates">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-dashboard.png" alt="Single Policy Analysis dashboard in Qumis showing recent reports" />
</Frame>
...
<Steps>
  ...
  <Step title="Or select from Vault">
...
<Frame caption="Upload policy documents by dragging and dropping files or selecting from your Document Vault">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-upload-document.png" alt="Uploading a policy document to Qumis Single Policy Analysis" />
</Frame>
...
<Frame caption="Add optional context about the prospect's industry, operations, or specific analysis focus areas">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-uploaded-documents.png" alt="Adding additional information for Single Policy Analysis" />
</Frame>
...
<Frame caption="Report generation progress showing compilation and validation stages (5–10 minutes)">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-additional-info.png" alt="Generating Single Policy Analysis report progress view" />
</Frame>
...
<Frame caption="Completed Single Policy Analysis report with executive summary, detailed findings, and interactive chat assistant">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-generate-report.png" alt="Completed Single Policy Analysis Report with Executive Summary and Chat" />
</Frame>
...
<Frame caption="Ask Qumis Clerk questions about specific policy provisions, exclusions, or coverage gaps">
  <img src="/_mintlify/image/qumis/images/screenshots/single-policy-report-results.png" alt="Chatting with Qumis Clerk about Single Policy Analysis report" />
</Frame>
...
<Steps>
  <Step title="Navigate to Single Policy">
    Go to **Single Policy** in the left sidebar.
  </Step>

  <Step title="Review your reports table">
...
<AccordionGroup>
  ...
  <Accordion title="One policy per report">
    Create separate analyses for each policy so reports stay organized and focused. For side-by-side comparisons, use the Compare Documents feature.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can I analyze more than one policy at once?">
    The Single Policy tool is designed for one document at a time to ensure accuracy and focus. For side-by-side comparisons, use the **Compare Documents** feature instead.
  </Accordion>
  ...
  <Accordion title="I want to compare two policies">
    Create separate Single Policy Analysis reports for each policy, then use the **Compare Documents** tool to review them side-by-side with detailed variance analysis.
  </Accordion>
</AccordionGroup>
...
Single Policy Analysis is purpose-built for the broker/producer workflow of evaluating prospects' existing policies. Use it alongside **Chats** for ad-hoc questions, **Compare Documents** for side-by-side policy reviews, and **Custom Reports** for tailored client deliverables.
...
<CardGroup cols={2}>
  <Card title="Compare Documents" icon="code-compare" href="/platform/compare">
    Compare two or more policies side by side
  </Card>
  <Card title="Custom Report" icon="file-pen" href="/platform/custom-report">
    Build a tailored analysis with your own prompts
  </Card>
  <Card title="Market Analysis Playbook" icon="chart-line" href="/playbooks/prospecting/market-analysis">
    Analyze a prospect's coverage before your first meeting
  </Card>
