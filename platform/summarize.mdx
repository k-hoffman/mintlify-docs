...
<Frame caption="Single Policy Analysis dashboard showing all saved reports with names, associated files, and last modified dates">
  <img src="/images/screenshots/single-policy-dashboard.png" alt="Single Policy Analysis dashboard in Qumis showing recent reports" />
</Frame>
...
<Frame caption="Upload policy documents by dragging and dropping files or selecting from your Document Vault">
  <img src="/images/screenshots/single-policy-upload-document.png" alt="Uploading a policy document to Qumis Single Policy Analysis" />
</Frame>
...
<Frame caption="Add optional context about the prospect's industry, operations, or specific analysis focus areas">
  <img src="/images/screenshots/single-policy-uploaded-documents.png" alt="Adding additional information for Single Policy Analysis" />
</Frame>
...
<Frame caption="Report generation progress showing compilation and validation stages (5–10 minutes)">
  <img src="/images/screenshots/single-policy-additional-info.png" alt="Generating Single Policy Analysis report progress view" />
</Frame>
...
<Frame caption="Completed Single Policy Analysis report with executive summary, detailed findings, and interactive chat assistant">
  <img src="/images/screenshots/single-policy-generate-report.png" alt="Completed Single Policy Analysis Report with Executive Summary and Chat" />
</Frame>
...
<Frame caption="Ask Qumis Clerk questions about specific policy provisions, exclusions, or coverage gaps">
  <img src="/images/screenshots/single-policy-report-results.png" alt="Chatting with Qumis Clerk about Single Policy Analysis report" />
</Frame>
